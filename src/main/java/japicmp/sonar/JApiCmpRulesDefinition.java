...
import static japicmp.sonar.JApiCmpSonarConstants.RULE_KEY_API_CHANGE;
...
public class JApiCmpRulesDefinition implements RulesDefinition {
    ...
    public static final RuleKey RULE_API_CHANGE = RuleKey.of(PLUGIN_KEY, RULE_KEY_API_CHANGE);
    public static final String API_TRACKING = "api-tracking";
	...
	public void define(Context context) {
        ...
        repository
                .createRule(RULE_KEY_API_CHANGE)
                .setName("API modification should not happen.")
                .setHtmlDescription(
                        "This API modification is not incompatible but should not happen for patch releases.")
                .setTags(JAPICMP, API_TRACKING)
                .setStatus(RuleStatus.READY)
